...
const SKILL_NAME = 'Your Hero';
const GET_HERO_MESSAGE = "Here's your hero: ";
const HELP_MESSAGE = 'You can say please give me a hero, or, you can say exit... What can I help you with?';
...
alexaRouter.post('/yourhero', function(req, res) {
...
function getNewHero() {
  ...
  var welcomeSpeechOutput = 'Welcome to your hero<break time="0.3s" />'
  if (!isFisrtTime) {
    welcomeSpeechOutput = '';
  }
